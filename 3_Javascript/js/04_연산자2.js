...
function compareFn2() {
    const v3 = Number(cv3.value); //string을 number타입으로 바꿔야 함
...
const result4 = document.getElementById("result4"); //span태그 부분
