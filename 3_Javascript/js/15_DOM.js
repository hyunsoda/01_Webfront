...
document.querySelector("#btn1").addEventListener("click",() => {
    ...
    console.log(test.firstChild); // 주석과 공백을 포함한 모든 자식 요소 중 첫 번째 요소
    ...
    // 3. 첫 번째 자식으로 추가 (prepend("내용" 또는 노드 또는 요소 * n개))
    list[11].prepend("오늘", "점심","뭐먹지?");

    // 4. 이전/다음 형제로 추가하기 (befor/after("내용" 또는 노드 또는 요소))
    // #test 전/후에 내용 추가
    test.before("이전입니다");
    test.after("이후입니다");
});
